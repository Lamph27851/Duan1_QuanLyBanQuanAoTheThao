            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(result_field, javax.swing.GroupLayout.PREFERRED_SIZE, 216, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(jlbKhachPhaiTra, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGroup(jPanel4Layout.createSequentialGroup()
    ...
    private void btnThemGioHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemGioHangActionPerformed
        ...
        if (index >= 0 && index <= listSPThemGioHang.size()) {
            ...
            if (Integer.parseInt(txtSoLuongMua.getText()) > spct.getSoLuong()) {
                ...
                jlbTongTien.setText(String.valueOf(tongTien) + " Đ");
                jlbTienGiam.setText(String.valueOf(tienPGG + tienQuyDoi) + " Đ");
                tienKhachPhaiTra = tongTien - (tienPGG + tienQuyDoi);
                jlbKhachPhaiTra.setText(String.valueOf(tienKhachPhaiTra) + " Đ");
                            ...
                            if (kh.getId() != khacLe()) {
                                for (QLBangTichDiem bangTichDiem : listBangTichDiem) {
                                    if (bangTichDiem.getIdKH() == kh.getId()) {
                                        ...
                                        btd.setTienDuocGiam(tiennBD + (diemThem * 1000));
